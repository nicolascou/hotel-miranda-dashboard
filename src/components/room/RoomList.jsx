...
const RoomList = () => {
  const [rooms, setRooms] = useState(rooms_json);
    ...
    <div className='bookings'>
      ...
      <div className='bookings__table'>
        <div className='bookings__table__row bookings__table__row--first'>
          <p className='bookings__table__row__item'>Photo</p>
          ...
          {sliceRooms.map((room) => {
            ...
            return (  
              <div key={room.id} onClick={() => navigate(`/rooms/${room.id}`)} className='bookings__table__row'>
                ...
                <p className='bookings__table__row__item'>{room.bed_type}</p>
                <p className='bookings__table__row__item'>{room.amenities}</p>
                <p className='bookings__table__row__item'>{room.rate}</p>
